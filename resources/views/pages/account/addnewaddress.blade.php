...
<div class="container ac-layout before-login">
  ...
  <form action="{{url('addnewaddress')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
  ...
  @csrf
    ...
    <div class="multiple-form-group">
      ...
      <div class="form-group required">
        ...
        <select name="zone_id" id="input-zone" class="form-control">
          ...
          <option value="322" selected="selected">Dhaka City</option>
    ...
    <div class="form-group">
      ...
      <label class="radio-inline">
        <input type="radio" name="default" value="1" checked="checked"> Yes </label>
      <label class="radio-inline">
        <input type="radio" name="default" value="0"> No </label>
    </div>
